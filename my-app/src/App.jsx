...
import { Trophy, Cpu, MessageSquare, Video, ExternalLink, GraduationCap, Calendar, MapPin, ChevronRight, Menu } from 'lucide-react';
    ...
    <div className="min-h-screen font-sans text-slate-900 selection:bg-blue-100 pb-24">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/40 backdrop-blur-md border-b border-blue-100/50">
        <div className="flex items-center justify-between px-5 h-16 max-w-[1126px] mx-auto">
          <div className="font-black text-xl tracking-tighter flex items-center gap-2 text-blue-900">
            <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center text-white text-xs shadow-lg shadow-blue-200">AI</div>
            AI VISION
          </div>
      ...
      <header className="relative pt-32 pb-8 px-6 text-center">
        ...
        <div className="max-w-md mx-auto">
          ...
          <h1 className="text-5xl md:text-6xl font-black leading-[1.1] tracking-tighter mb-6 text-slate-900">
            AI VISION <br />
            <span className="text-blue-600">2K26.</span>
          </h1>

          {/* Snippet with Address */}
          <p className="text-slate-500 text-base mb-10 leading-relaxed font-medium px-2">
            Securing your Future with your own Hands.<br/>
            <span className="text-blue-700 font-bold uppercase tracking-widest text-[10px] block mt-2">
              G-NTTF Campus <br/>
              Opp. New DC Office, Hubli Road, Gadag 582103
            </span>
          </p>
        </div>
      </header>
      ...
      <section className="px-5 py-4">
        <h2 className="text-2xl font-black mb-8 text-center text-slate-800 tracking-tight">THE CHALLENGES</h2>
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-4 bg-white/60 backdrop-blur-sm p-4 rounded-2xl border border-white shadow-sm transition-transform active:scale-[0.98]">
            ...
            <div className="text-left">
              ...
              <p className="font-bold text-sm text-slate-700">17 & 18 April 2026</p>
            </div>
          </div>
          <div className="flex items-center gap-4 bg-white/60 backdrop-blur-sm p-4 rounded-2xl border border-white shadow-sm transition-transform active:scale-[0.98]">
            <div className="bg-blue-100 p-2 rounded-xl text-blue-600">
      ...
      {/* Fixed Footer Register Button with Link */}
